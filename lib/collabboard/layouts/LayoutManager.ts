...
import { calculateGridPositions } from './GridLayout.tsx';
...
import { calculateMapPositions } from './MapLayout';
...
const layoutFunctions: Partial<Record<LayoutType, CalculatePositionsFunction>> = {
  wall: calculateWallPositions,
  columns: calculateColumnsPositions,
  grid: calculateGridPositions as unknown as CalculatePositionsFunction,
  ...
  map: calculateMapPositions as unknown as CalculatePositionsFunction,
};
...
export class LayoutManager {
  ...
  static getLayoutDisplayName(layoutType: LayoutType): string {
    const displayNames: Partial<Record<LayoutType, string>> = {
      wall: 'Wall',
      columns: 'Columns',
      grid: 'Grid',
      table: 'Table',
  ...
  static getLayoutDescription(layoutType: LayoutType): string {
    const descriptions: Partial<Record<LayoutType, string>> = {

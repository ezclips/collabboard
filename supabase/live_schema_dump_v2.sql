...
CREATE TABLE IF NOT EXISTS "public"."share_links" (
    ...
    "board_id" "uuid",
    "share_target" "text" DEFAULT 'post-in-board'::"text",
    CONSTRAINT "share_links_share_target_check" CHECK (("share_target" = ANY (ARRAY['post'::"text", 'board'::"text", 'post-in-board'::"text"])))
);
...
CREATE POLICY "share_links_delete_own" ON "public"."share_links" FOR DELETE TO "authenticated" USING (("created_by" = "auth"."uid"()));



CREATE POLICY "share_links_insert_own" ON "public"."share_links" FOR INSERT TO "authenticated" WITH CHECK (("created_by" = "auth"."uid"()));



CREATE POLICY "share_links_select_own" ON "public"."share_links" FOR SELECT TO "authenticated" USING (("created_by" = "auth"."uid"()));



CREATE POLICY "share_links_update_own" ON "public"."share_links" FOR UPDATE TO "authenticated" USING (("created_by" = "auth"."uid"())) WITH CHECK (("created_by" = "auth"."uid"()));
...
GRANT SELECT("share_target") ON TABLE "public"."share_links" TO "anon";
GRANT SELECT("share_target") ON TABLE "public"."share_links" TO "authenticated";

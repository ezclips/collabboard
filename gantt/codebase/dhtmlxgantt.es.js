...
const _a = (t) => {
  Je() || setTimeout(() => {
    ...
    if (!(typeof 1771397103000 > "u")) {
      var e, n;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1771397103000 > 5184e6 && t.message({ type: "error", text: i, expire: -1, id: "evaluation-warning" });
...
`);
    if (typeof 1771397103000 > "u") return;
    const e = function() {
      var n, a;
      setTimeout(() => {
        Date.now() - 1771397103000 > 7776e6 && window.alert(i), e();
...
q.gantt = nr, q.Gantt = ze, ze.plugin((t) => {
  Je() || setTimeout(() => {
    ...
    if (!(typeof 1771397103000 > "u")) {
      var e, n;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1771397103000 > 27648e5 && t.message({ type: "error", text: i, expire: -1, id: "evaluation-warning" });

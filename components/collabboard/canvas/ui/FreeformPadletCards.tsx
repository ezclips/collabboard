...
export interface FreeformPadletCardsProps {
  ...
  // Detached popup / collapsed state
  ...
  // Comment popup (inline text comments)
...
function FreeformPadletCards(props: FreeformPadletCardsProps) {
  const {
    rootPadlets, padlets, setPadlets, canvasZoom, canvasId, user, containerRef,
    isDragging, draggingPadletId, isFreeformGraphMode, isGraphConnectMode,
    isLineMode, isDrawingMode, isColumnsLayout, canUseFreeformEditButton,
    ...
    setIsImageEditorOpen, setIsDrawingEditorOpen, setIsCardEditorOpen, setIsCardViewerOpen,
    setIsAIComponentEditorOpen, setIsAIContentEditModalOpen, setIsAIContentConvertModalOpen,
    ...
    imageColorTab, setImageColorTab,
    ...
    cardToolbarPadletId, setCardToolbarPadletId,
    isCardColorPickerOpen, setIsCardColorPickerOpen,
    cardColorTab, setCardColorTab,
    captionEditorPadletId, setCaptionEditorPadletId,
    ...
    activeCardCommentId, setActiveCardCommentId,
    editingCardCommentId, setEditingCardCommentId,
    editingCardCommentText, setEditingCardCommentText,
    commentColorPopupId, setCommentColorPopupId,
    activeCardComment,
    noteBadgeColorPadletId, setNoteBadgeColorPadletId,
    internalBadgeColorPopupId, setInternalBadgeColorPopupId,
    internalBadgePopupPosition, setInternalBadgePopupPosition,
    setDetachedPopupPosition, setDetachedPopupPadletId,
    setDetachedBadgeColorOpen, setDetachedPopupComments, setDetachedPopupOpen,
    collapsedPopupPadletId, setCollapsedPopupPadletId,
    collapsedBadgeColorOpen, setCollapsedBadgeColorOpen,
    collapsedActiveCommentId, setCollapsedActiveCommentId,
    collapsedEditingCommentId, setCollapsedEditingCommentId,
    collapsedEditingText, setCollapsedEditingText,
    collapsedCommentColorPopupId, setCollapsedCommentColorPopupId,
    ...
    setCommentPopupPadletId, setCommentPopupCommentId,
    setCommentPopupOpen, setCommentPopupHighlightColor,
    setTextLinkColorPickerPosition, setTextLinkColorPickerOpen,
    commentPopupPosition, commentPopupHighlightColor,
    closeAllToolbars, handlePadletMouseDown, getClickedSide,
    duplicatePadlet, requestDeletePadlet, cutPadlet, copyPadlet,
    lockPadlet, movePadletLayer, groupIntoColumn,
    replaceImage, downloadImage, toggleCropToGrid,
    handlePaste, renameComment, renameColumn, renameTodo,
    createSyncedCopy, addImageToLink, copyLinkAddress,
    deletePadletById, fetchData,
    updatePadletMetadata, updatePadletTitle, updatePadletContent, commitPadletMeta,
  } = props;

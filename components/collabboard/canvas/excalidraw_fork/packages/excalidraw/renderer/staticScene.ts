...
const renderLinkIcon = (
  ...
  // Padlet: suppress the blue link icon layer for embeddable elements (our containers have custom UI)
  if (element.link && !appState.selectedElementIds[element.id] && !isEmbeddableElement(element)) {

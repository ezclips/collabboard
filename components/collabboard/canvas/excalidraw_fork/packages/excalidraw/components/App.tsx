...
class App extends React.Component<AppProps, AppState> {
  ...
  constructor(props: AppProps) {
    ...
    if (excalidrawAPI) {
      const api: ExcalidrawImperativeAPI = {
        ...
        updateBoundElements: this.updateBoundElements,
      ...
      <>
        {embeddableElements.map((el) => {
          ...
          return (
            ...
            >
              <div
                //this is a hack that addresses issues with embedded content
                ...
                style={{
                  ...
                  pointerEvents: (() => {
                    ...
                    // Disable pointer events on padlets while drawing or dragging arrow/line
                    // endpoints so Excalidraw's canvas can detect binding to the container.
                    const toolType = this.state.activeTool.type;
                    const isDrawingLinear = toolType === "arrow" || toolType === "line";
                    const isDraggingLinearPoint = this.state.selectedLinearElement?.isDragging === true;
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](the Canvas documentation) for more details.
       *
  ...
  public updateBoundElements = (element: NonDeletedExcalidrawElement) => {
  ...
  private handleCanvasPointerMove = (
    ...
    if (
      ...
      if (
        hitElement &&
        // Padlet: suppress hyperlink popup for embeddable elements (we render our own containers)
  ...
  private handleCanvasPointerDown = (
    ...
    if (this.state.contextMenu) {
      this.setState({ contextMenu: null });
      // Return early so the pointerdown that dismisses the context menu does
      // not also start a rubber-band selection or drag operation.
      return;
    }
      ...
      if (
        ...
        this.setState((prevState) => {
          ...
          return {
            ...
            showHyperlinkPopup:
              // Padlet: suppress hyperlink popup/icon for embeddable elements
              !isEmbeddableElement(hitElement) && hitElement.link
                ? "info"
                : false,
          };
        });
    ...
    return withBatchedUpdates((childEvent: PointerEvent) => {
      ...
      if (!activeTool.locked && activeTool.type !== "freedraw" && newElement) {
        this.setState((prevState) => ({
          ...
          showHyperlinkPopup:
            isEmbeddableElement(newElement)
              ? false

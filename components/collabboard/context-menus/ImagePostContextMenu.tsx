        ...
        <ContextMenu.Root onOpenChange={(open) => { if (open) onSelect(); }}>
            ...
            <ContextMenu.Portal>
                ...
                >
                    ...
                    <ContextMenuItem label="Replace Image" onClick={() => handleAction('image.replace')} />
                    <ContextMenuItem label="Download Original Image" onClick={() => handleAction('image.download')} />
                    <ContextMenu.Item
                        ...
                        onClick={() => handleAction('image.cropToGrid')}
                    >
                    ...
                    <ContextMenuItem label="Group into Column" onClick={() => handleAction('post.groupIntoColumn')} />

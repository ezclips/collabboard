...
import { BoardSection, Padlet, DropIndicatorState, ColumnDragPayload, DND_KIND_POST_MOVE, DND_KIND_CONTAINER_MOVE } from "../../../types/collabboard";
...
export default function ColumnsLayout({
    ...
    return (
        <div className="flex flex-col w-[280px] h-full min-h-0 flex-shrink-0 group/section">
            ...
            <div
                ref={scrollElRef}
                className="flex-1 min-h-0 overflow-y-auto pb-20 pr-2 no-scrollbar space-y-4"
                ...
                onDrop={async (e) => {
                    ...
                    console.log('[ColumnsLayout] Drop:', { kind, id, toSection: section.id, targetIndex, fromSectionId });
                    console.log('[DROP commit]', {

                            ...
                            <div key={post.id} data-drop-index={index} data-post-id={post.id} className="relative">
                                ...
                                >
                                    <div
                                        ...
                                        className={cn(
                                            "group relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all border border-gray-300/80 overflow-hidden px-5 py-4 min-h-[160px] cursor-grab active:cursor-grabbing select-none w-full"
                                        )}
                                    ...
                                    >
                                        ...
                                        <div className="text-base text-gray-800 whitespace-pre-line break-words select-text w-full overflow-hidden container-content">

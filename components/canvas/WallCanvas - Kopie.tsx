...
const WallCanvas: React.FC<WallCanvasProps> = ({
  ...
  return (
    ...
    >
      {/* Canvas Header */}
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-sm border-b border-gray-200 px-6 py-3">
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          <h1 className="text-xl font-semibold text-pink-600">My fancy padlet</h1>
